<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Portal do TCC - Autenticação</title>
    ...
    <body class="login-content">
        ...
        <div class="lc-block toggled" id="l-login">
            <form action="validate.php?page=2" method="post">
            ...
            <ul class="login-navigation">
                <li data-block="#l-register" class="bgm-red">Criar Nova Conta</li>
            </ul>
        ...
        <div class="lc-block" id="l-register">
            ...
            <ul class="login-navigation">
                <li data-block="#l-login" class="bgm-unipam-blue">Autenticar</li>
            </ul>
        </div>
